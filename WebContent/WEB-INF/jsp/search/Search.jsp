...
<logic:equal name="PartToShow" value="BankDuplicatesResult">
 	<jsp:include page="/WEB-INF/jsp/search/Searchvalid.jsp"></jsp:include>
</logic:equal>
...
<logic:equal name="PartToShow" value="KOTNochequesResult">
 <table cellpadding="5" cellspacing="0" border="0" width="100%">   
 <tr><br /><td colspan="2" width="100%" class="tbn" height="20" align="left">CHEQUE NO. NOT EXISTS RECORDS</td></tr> 
...
<table border="0" cellpadding="0" cellspacing="0" width="75%" align="center">
  <tr>
     <td align="center" colspan="2">
	    ...
	    <display:column style="text-align:center;width:130px" sortable="true" title="DEPSLIP No." property="k_depositslipno" media="html" />
