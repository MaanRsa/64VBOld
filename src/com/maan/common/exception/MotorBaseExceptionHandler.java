...
public class MotorBaseExceptionHandler extends ExceptionHandler {
	...
	public ActionForward execute(final Exception exception,
		...
		try {
			...
			String expMsg;
			String msg;
			if (exception instanceof MotorBaseException) {
				final MotorBaseException hbex = (MotorBaseException) exception;
