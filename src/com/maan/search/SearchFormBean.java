...
public class SearchFormBean extends ActionForm  implements Cloneable{
	...
	private HashMap reversalMap = new HashMap();
	private HashMap chequeNos = new HashMap();
	private String searchIn="Both";
	...
	public List nonmatchedlist;
	private int bankReversalSize;
	private int nonMathcedReceiptSize;
	private int nonMatchedBankSize;
	private String bankData;
	private String excelBankNo;
	...
	public String getExcelBankNo() {
		return excelBankNo;
	}

	public void setExcelBankNo(String excelBankNo) {
		this.excelBankNo = excelBankNo;
	}
	...
	public int getBankReversalSize() {
		return bankReversalSize;
	}

	public void setBankReversalSize(int bankReversalSize) {
		this.bankReversalSize = bankReversalSize;
	}

	public int getNonMathcedReceiptSize() {
		return nonMathcedReceiptSize;
	}

	public void setNonMathcedReceiptSize(int nonMathcedReceiptSize) {
		this.nonMathcedReceiptSize = nonMathcedReceiptSize;
	}

	public int getNonMatchedBankSize() {
		return nonMatchedBankSize;
	}

	public void setNonMatchedBankSize(int nonMatchedBankSize) {
		this.nonMatchedBankSize = nonMatchedBankSize;
	}

	public List getNonmatchedlist() {
		return nonmatchedlist;
	}

	public void setNonmatchedlist(List nonmatchedlist) {
		this.nonmatchedlist = nonmatchedlist;
	}

	public HashMap getReversalMap() {
		return reversalMap;
	}

	public void setReversalMap(HashMap reversalMap) {
		this.reversalMap = reversalMap;
	}
	...
	public Object clone(){
		SearchFormBean cloned=null;
		  try{
		   cloned = (SearchFormBean)super.clone();
		  }
		  catch(Exception e)
		  {}
		  return cloned;
